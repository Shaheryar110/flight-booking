...
setAircraft(aircraftData)
  ...
  React.useEffect(()=>{
    ...
    React.useEffect(()=>{
        if(id){
            getSpcecificFlight(id).then((data)=>{console.log(data);setFormData(data)})
  ...
  return (
    ...
    >
      <DialogTitle sx={{textAlign:"center",fontFamily:"'poppins'",color:"white",fontSize:"25px",fontWeight:600}}>Edit Flight</DialogTitle>
      <DialogContent >
